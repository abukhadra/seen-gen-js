...
//------------------------------------------------------------------------------
`;function U(n,e){const{version:r}=require(n);(void 0)(e,"utf8",(i,o)=>{if(i){console.error(i);return}(void 0)(e,`/*version: ${r}*/
${o}`,t=>{if(t){console.error(t);return}})})}export{b as ANY_LETTER,d as ANY_NUM,q as HELPERS,u as MAGHRIB_DIGIT,c as MASHRIQ_DIGIT,p as TATWEEL,U as appendPkgVersion,N as assign,O as c0_to_uppercase,J as clone,A as concat,s as contains,E as del,m as is_empty,v as is_list,f as is_maghrib_num,l as is_mashriq_num,h as is_none,a as panic,R as pprint,S as print,I as println,C as regexp,L as repeat,w as replace,x as to_int,T as to_lowercase,y as to_maghrib_digit,g as to_maghrib_num,_ as to_mashriq_digit,k as to_mashriq_num,j as to_str};
